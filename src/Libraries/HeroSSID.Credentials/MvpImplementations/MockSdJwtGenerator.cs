...
namespace HeroSSID.Credentials.MvpImplementations;
...
{
    private static readonly string[] W3cVcContext = ["https://www.w3.org/2018/credentials/v1"];
    private static readonly string[] VerifiableCredentialType = ["VerifiableCredential"];
